            ...
            <div className="grid lg:grid-cols-[300px,1fr] gap-4">
                <div className="border border-gray-300 rounded-2xl grid place-items-center p-6 lg:p-0">
                    <div className="text-center flex flex-col items-center gap-1">
                        <Image className='rounded-full inline-block' src="/dp.jpg" width={80} height={80} alt="Avatar" />
                        <Image className='inline-block py-2' src="/quote.png" width={30} height={30} alt='quotes' />
                        <p className='max-w-200px text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad iusto aliquam voluptate dolor, est deserunt?</p>
                    </div>
                </div>
